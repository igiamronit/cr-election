...
const AdminDashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      const response = await axios.get('https://cr-election-production.up.railway.app/api/admin/stats', getAuthHeaders());
  ...
  const fetchKeys = async () => {
    try {
      const response = await axios.get('https://cr-election-production.up.railway.app/api/admin/keys', getAuthHeaders());
  ...
  const generateKeys = async () => {
    setLoading(true);
    try {
      const response = await axios.post('https://cr-election-production.up.railway.app/api/admin/generate-keys', {}, getAuthHeaders());
  ...
  const updateCandidates = async () => {
    ...
    try {
      const response = await axios.post(
        'https://cr-election-production.up.railway.app/api/admin/candidates',
  ...
  const toggleVotingSession = async (action) => {
    ...
    try {
      const response = await axios.post(
        'https://cr-election-production.up.railway.app/api/admin/voting-session',
        { action },
        getAuthHeaders()
      );
  ...
  const resetAllData = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('https://cr-election-production.up.railway.app/api/admin/reset', {}, getAuthHeaders());
      if (response.data.success) {
