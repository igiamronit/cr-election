...
const VotingPage = () => {
  ...
  const fetchCandidates = async () => {
    try {
      const response = await axios.get('https://cr-election-uk6a.onrender.com/api/candidates');
  ...
  try {
    ...
    const response = await axios.get('https://cr-election-uk6a.onrender.com/api/session-status');
  ...
  const validateKey = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('https://cr-election-uk6a.onrender.com/api/auth/validate-key', {
  ...
  const castVote = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://cr-election-uk6a.onrender.com/api/votes/cast',
